...
class Profile(models.Model):
    ...
    job_title = models.CharField(max_length=50, null=True, blank=True,choices=JOB_TITLE_CHOICES)
    # new field
    passcode = models.CharField(max_length=12, null=True, blank=True)
    ...
    def get_picture(self):
        no_picture = 'http://trybootcamp.vitorfs.com/static/img/user.png' # TODO: change to local
        try:
